...
// console.log(sumaDosArrays(arrayUno,arrayDos));
...
// let arrayAnalizar = [1,45,3,4,5];


// console.log(`El nummero mayor del array ${arrayAnalizar} es ${buscarMayor(arrayAnalizar)}`);
